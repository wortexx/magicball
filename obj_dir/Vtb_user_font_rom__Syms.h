...
#ifndef VERILATED_VTB_USER_FONT_ROM__SYMS_H_
#define VERILATED_VTB_USER_FONT_ROM__SYMS_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES)Vtb_user_font_rom__Syms final : public VerilatedSyms {
  public:
    // INTERNAL STATE
    Vtb_user_font_rom* const __Vm_modelp;
    ...
    Vtb_user_font_rom___024root    TOP;
    Vtb_user_font_rom_soc_ctrl_reg_pkg TOP__soc_ctrl_reg_pkg;
    ...
    // CONSTRUCTORS
    Vtb_user_font_rom__Syms(VerilatedContext* contextp, const char* namep, Vtb_user_font_rom* modelp);
