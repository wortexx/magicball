...
VL_ATTR_COLD void Vtb_obi_spi_direct___024root___ctor_var_reset(Vtb_obi_spi_direct___024root* vlSelf) {
    ...
    vlSelf->__Vdly__tb_obi_spi_direct__DOT__dut__DOT__rvalid_q = VL_RAND_RESET_I(1);
    vlSelf->__Vdly__tb_obi_spi_direct__DOT__dut__DOT__rdata_q = VL_RAND_RESET_I(32);
