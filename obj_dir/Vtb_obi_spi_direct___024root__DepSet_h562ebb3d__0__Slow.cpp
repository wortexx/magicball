...
VL_ATTR_COLD void Vtb_obi_spi_direct___024root___ctor_var_reset(Vtb_obi_spi_direct___024root* vlSelf) {
    ...
    vlSelf->tb_obi_spi_direct__DOT__status_after_done = VL_RAND_RESET_I(32);
    vlSelf->tb_obi_spi_direct__DOT__final_status = VL_RAND_RESET_I(32);
    ...
    vlSelf->tb_obi_spi_direct__DOT__dut__DOT__cs_no = VL_RAND_RESET_I(1);
