...
VL_ATTR_COLD void Vtb_obi_spi_direct___024root__trace_init_sub__TOP__0(Vtb_obi_spi_direct___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+37,0,"SPI_CTRL_ADDR_OFFSET",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 11,0);
    tracep->declBus(c+38,0,"SPI_TX_ADDR_OFFSET",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 11,0);
    tracep->declBus(c+39,0,"SPI_STATUS_ADDR_OFFSET",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 11,0);
    tracep->declBit(c+28,0,"clk_i",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+29,0,"gnt_o",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+9,0,"rvalid_o",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+10,0,"rdata_o",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBit(c+13,0,"cs_no",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+13,0,"cs_no",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+17,0,"start_flag_d",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+18,0,"tx_data_q",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+18,0,"tx_data_d",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+19,0,"bit_cnt_q",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    ...
    tracep->declBus(c+21,0,"spi_clk_cnt_q",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 1,0);
    tracep->declBus(c+22,0,"spi_clk_cnt_d",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 1,0);
    ...
    tracep->declBit(c+27,0,"read_req_granted_q",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->pushPrefix("unnamedblk1", VerilatedTracePrefixType::SCOPE_MODULE);
    tracep->declBus(c+43,0,"next_mosi_idx",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->popPrefix();
    tracep->popPrefix();
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vtb_obi_spi_direct___024root__trace_const_0_sub_0(Vtb_obi_spi_direct___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+36,(0x2710U),32);
    bufp->fullSData(oldp+37,(0U),12);
    bufp->fullSData(oldp+38,(4U),12);
    bufp->fullSData(oldp+39,(8U),12);
    bufp->fullIData(oldp+40,(0x20U),32);
    bufp->fullIData(oldp+41,(8U),32);
    bufp->fullIData(oldp+42,(2U),32);
    bufp->fullCData(oldp+43,(vlSelfRef.tb_obi_spi_direct__DOT__dut__DOT__unnamedblk1__DOT__next_mosi_idx),3);
}
...
VL_ATTR_COLD void Vtb_obi_spi_direct___024root__trace_full_0_sub_0(Vtb_obi_spi_direct___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+2,(vlSelfRef.tb_obi_spi_direct__DOT__req_i));
    bufp->fullBit(oldp+3,(vlSelfRef.tb_obi_spi_direct__DOT__we_i));
    bufp->fullCData(oldp+4,(vlSelfRef.tb_obi_spi_direct__DOT__be_i),4);
    bufp->fullIData(oldp+5,(vlSelfRef.tb_obi_spi_direct__DOT__addr_i),32);
    bufp->fullIData(oldp+6,(vlSelfRef.tb_obi_spi_direct__DOT__wdata_i),32);
    bufp->fullBit(oldp+7,(vlSelfRef.tb_obi_spi_direct__DOT__req_ongoing));
    bufp->fullBit(oldp+8,(((~ (IData)(vlSelfRef.tb_obi_spi_direct__DOT__we_i)) 
    ...
    bufp->fullBit(oldp+13,(vlSelfRef.tb_obi_spi_direct__DOT__cs_no));
    ...
    bufp->fullBit(oldp+17,(vlSelfRef.tb_obi_spi_direct__DOT__dut__DOT__start_flag_d));
    bufp->fullCData(oldp+18,(vlSelfRef.tb_obi_spi_direct__DOT__dut__DOT__tx_data_q),8);
    bufp->fullCData(oldp+19,(vlSelfRef.tb_obi_spi_direct__DOT__dut__DOT__bit_cnt_q),3);
    bufp->fullCData(oldp+20,(vlSelfRef.tb_obi_spi_direct__DOT__dut__DOT__bit_cnt_d),3);
    bufp->fullCData(oldp+21,(vlSelfRef.tb_obi_spi_direct__DOT__dut__DOT__spi_clk_cnt_q),2);
    bufp->fullCData(oldp+22,(vlSelfRef.tb_obi_spi_direct__DOT__dut__DOT__spi_clk_cnt_d),2);
    bufp->fullBit(oldp+23,((2U <= (IData)(vlSelfRef.tb_obi_spi_direct__DOT__dut__DOT__spi_clk_cnt_q))));
    bufp->fullCData(oldp+24,(vlSelfRef.tb_obi_spi_direct__DOT__dut__DOT__status_bits),2);
    ...
    bufp->fullBit(oldp+26,(vlSelfRef.tb_obi_spi_direct__DOT__dut__DOT__done_q));
    bufp->fullBit(oldp+27,(vlSelfRef.tb_obi_spi_direct__DOT__dut__DOT__read_req_granted_q));
    bufp->fullBit(oldp+28,(vlSelfRef.tb_obi_spi_direct__DOT__clk_i));
    bufp->fullBit(oldp+29,(vlSelfRef.tb_obi_spi_direct__DOT__gnt_o));
    bufp->fullBit(oldp+30,(((IData)(vlSelfRef.tb_obi_spi_direct__DOT__we_i) 
                            & ((0U == (IData)(vlSelfRef.tb_obi_spi_direct__DOT__dut__DOT__state_q)) 
                               & ((4U == (0xfffU & vlSelfRef.tb_obi_spi_direct__DOT__addr_i)) 
                                  | (0U == (0xfffU 
