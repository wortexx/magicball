...
VL_ATTR_COLD void Vtb_obi_spi_direct___024root__trace_init_sub__TOP__0(Vtb_obi_spi_direct___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+37,0,"SPI_CTRL_ADDR_OFFSET",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+38,0,"SPI_TX_ADDR_OFFSET",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+39,0,"SPI_STATUS_ADDR_OFFSET",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+43,0,"SPI_CTRL_ADDR_OFFSET",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 11,0);
    tracep->declBus(c+44,0,"SPI_TX_ADDR_OFFSET",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 11,0);
    tracep->declBus(c+45,0,"SPI_STATUS_ADDR_OFFSET",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 11,0);
    ...
    tracep->declBit(c+29,0,"gnt_for_write",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+30,0,"read_req_accepted_this_cycle",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->pushPrefix("unnamedblk1", VerilatedTracePrefixType::SCOPE_MODULE);
    tracep->declBus(c+46,0,"next_mosi_idx",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->popPrefix();
    tracep->popPrefix();
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vtb_obi_spi_direct___024root__trace_const_0_sub_0(Vtb_obi_spi_direct___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullSData(oldp+43,(0U),12);
    bufp->fullSData(oldp+44,(4U),12);
    bufp->fullSData(oldp+45,(8U),12);
    bufp->fullCData(oldp+46,(vlSelfRef.tb_obi_spi_direct__DOT__dut__DOT__unnamedblk1__DOT__next_mosi_idx),3);
}
...
VL_ATTR_COLD void Vtb_obi_spi_direct___024root__trace_full_0_sub_0(Vtb_obi_spi_direct___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+24,((((IData)(vlSelfRef.tb_obi_spi_direct__DOT__dut__DOT__done_q) 
    ...
    bufp->fullBit(oldp+27,(vlSelfRef.tb_obi_spi_direct__DOT__clk));
    bufp->fullBit(oldp+28,(vlSelfRef.tb_obi_spi_direct__DOT__gnt));
    bufp->fullBit(oldp+29,(((IData)(vlSelfRef.tb_obi_spi_direct__DOT__we) 
    ...
    bufp->fullBit(oldp+30,(vlSelfRef.tb_obi_spi_direct__DOT__dut__DOT__read_req_accepted_this_cycle));
}
