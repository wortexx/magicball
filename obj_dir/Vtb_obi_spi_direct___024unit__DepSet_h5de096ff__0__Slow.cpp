...
VL_ATTR_COLD void Vtb_obi_spi_direct___024unit___ctor_var_reset(Vtb_obi_spi_direct___024unit* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_obi_spi_direct__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_obi_spi_direct___024unit___ctor_var_reset\n"); );
