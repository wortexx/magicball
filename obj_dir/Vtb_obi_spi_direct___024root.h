...
class Vtb_obi_spi_direct___024unit;
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_obi_spi_direct___024root final : public VerilatedModule {
  public:
    // CELLS
    Vtb_obi_spi_direct___024unit* __PVT____024unit;

    // DESIGN SPECIFIC STATE
    CData/*0:0*/ tb_obi_spi_direct__DOT__clk_i;
    CData/*0:0*/ tb_obi_spi_direct__DOT__rst_ni;
    CData/*0:0*/ tb_obi_spi_direct__DOT__req_i;
    CData/*0:0*/ tb_obi_spi_direct__DOT__we_i;
    CData/*3:0*/ tb_obi_spi_direct__DOT__be_i;
    CData/*0:0*/ tb_obi_spi_direct__DOT__gnt_o;
    ...
    CData/*0:0*/ tb_obi_spi_direct__DOT__dut__DOT__read_req_granted_q;
    CData/*2:0*/ tb_obi_spi_direct__DOT__dut__DOT__unnamedblk1__DOT__next_mosi_idx;
    CData/*0:0*/ __VstlFirstIteration;
    CData/*0:0*/ __Vtrigprevexpr___TOP__tb_obi_spi_direct__DOT__clk_i__0;
    CData/*0:0*/ __Vtrigprevexpr___TOP__tb_obi_spi_direct__DOT__rst_ni__0;
    CData/*0:0*/ __VactContinue;
    IData/*31:0*/ tb_obi_spi_direct__DOT__addr_i;
    IData/*31:0*/ tb_obi_spi_direct__DOT__wdata_i;
    IData/*31:0*/ tb_obi_spi_direct__DOT__dut__DOT__rdata_q;
    IData/*31:0*/ __VactIterCount;
    VlUnpacked<CData/*0:0*/, 4> __Vm_traceActivity;
    VlDelayScheduler __VdlySched;
    VlTriggerScheduler __VtrigSched_h72f6d80e__0;
