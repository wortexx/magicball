...
VL_ATTR_COLD void Vtb_user_domain_hw_ctrl___024root___dump_triggers__stl(Vtb_user_domain_hw_ctrl___024root* vlSelf) {
    ...
    if ((2ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 1 is active: @([hybrid] tb_user_domain_hw_ctrl.dut.__Vcellout__i_spi_peripheral__gnt_o)\n");
    }
    if ((4ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 2 is active: @([hybrid] tb_user_domain_hw_ctrl.dut.user_prng_obi_rsp)\n");
    }
    if ((8ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 3 is active: @([hybrid] tb_user_domain_hw_ctrl.dut.user_font_rom_obi_rsp)\n");
    }
    if ((0x10ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 4 is active: @([hybrid] tb_user_domain_hw_ctrl.dut.user_spi_ctrl_obi_rsp)\n");
    }
...
VL_ATTR_COLD void Vtb_user_domain_hw_ctrl___024root___dump_triggers__act(Vtb_user_domain_hw_ctrl___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @([hybrid] tb_user_domain_hw_ctrl.dut.__Vcellout__i_spi_peripheral__gnt_o)\n");
    }
    if ((2ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @([hybrid] tb_user_domain_hw_ctrl.dut.user_prng_obi_rsp)\n");
    }
    if ((4ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 2 is active: @([hybrid] tb_user_domain_hw_ctrl.dut.user_font_rom_obi_rsp)\n");
    }
    if ((8ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 3 is active: @([hybrid] tb_user_domain_hw_ctrl.dut.user_spi_ctrl_obi_rsp)\n");
    }
...
VL_ATTR_COLD void Vtb_user_domain_hw_ctrl___024root___dump_triggers__nba(Vtb_user_domain_hw_ctrl___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @([hybrid] tb_user_domain_hw_ctrl.dut.__Vcellout__i_spi_peripheral__gnt_o)\n");
    }
    if ((2ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @([hybrid] tb_user_domain_hw_ctrl.dut.user_prng_obi_rsp)\n");
    }
    if ((4ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 2 is active: @([hybrid] tb_user_domain_hw_ctrl.dut.user_font_rom_obi_rsp)\n");
    }
    if ((8ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 3 is active: @([hybrid] tb_user_domain_hw_ctrl.dut.user_spi_ctrl_obi_rsp)\n");
    }
...
VL_ATTR_COLD void Vtb_user_domain_hw_ctrl___024root___ctor_var_reset(Vtb_user_domain_hw_ctrl___024root* vlSelf) {
    ...
    vlSelf->tb_user_domain_hw_ctrl__DOT__dut__DOT__i_obi_demux_user__DOT__grant_condition_is_met_for_read = VL_RAND_RESET_I(1);
    ...
    vlSelf->tb_user_domain_hw_ctrl__DOT__dut__DOT__i_spi_peripheral__DOT__rvalid_q_internal = VL_RAND_RESET_I(1);
    vlSelf->tb_user_domain_hw_ctrl__DOT__dut__DOT__i_spi_peripheral__DOT__rdata_q_internal = VL_RAND_RESET_I(32);
    vlSelf->tb_user_domain_hw_ctrl__DOT__dut__DOT__i_spi_peripheral__DOT__was_read_granted_to_status_prev_cycle = VL_RAND_RESET_I(1);
    vlSelf->tb_user_domain_hw_ctrl__DOT__dut__DOT__i_spi_peripheral__DOT__data_for_rvalid_q = VL_RAND_RESET_I(32);
    ...
    vlSelf->tb_user_domain_hw_ctrl__DOT__dut__DOT__i_spi_peripheral__DOT__gnt_for_read_status_comb = VL_RAND_RESET_I(1);
    ...
    vlSelf->__Vtask_tb_user_domain_hw_ctrl__DOT__send_byte_hw_ctrl__61__cs_pin_idx = 0;
    vlSelf->__Vtask_tb_user_domain_hw_ctrl__DOT__send_byte_hw_ctrl__61__is_data = 0;
    vlSelf->__Vtask_tb_user_domain_hw_ctrl__DOT__send_byte_hw_ctrl__61__byte_val = VL_RAND_RESET_I(8);
    vlSelf->__Vtask_tb_user_domain_hw_ctrl__DOT__read_obi__77__r_addr = VL_RAND_RESET_I(32);
    vlSelf->__Vtask_tb_user_domain_hw_ctrl__DOT__read_obi__77__timeout_count_rvalid = 0;
