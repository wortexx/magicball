...
class alignas(VL_CACHE_LINE_BYTES) Vtb_user_domain_hw_ctrl___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*1:0*/ tb_user_domain_hw_ctrl__DOT__dut__DOT__user_idx;
        CData/*0:0*/ tb_user_domain_hw_ctrl__DOT__dut__DOT____Vcellout__i_spi_peripheral__gnt_o;
        CData/*0:0*/ tb_user_domain_hw_ctrl__DOT__dut__DOT__i_addr_decode_periphs__DOT__dec_valid_o;
        CData/*0:0*/ tb_user_domain_hw_ctrl__DOT__dut__DOT__i_addr_decode_periphs__DOT__dec_error_o;
        CData/*2:0*/ tb_user_domain_hw_ctrl__DOT__dut__DOT__i_addr_decode_periphs__DOT__i_addr_decode_dync__DOT__matched_rules;
        CData/*0:0*/ tb_user_domain_hw_ctrl__DOT__dut__DOT__i_obi_demux__DOT__cnt_up;
        ...
        CData/*0:0*/ tb_user_domain_hw_ctrl__DOT__dut__DOT__i_user_spi_ctrl__DOT__cs2_n_d;
        CData/*0:0*/ tb_user_domain_hw_ctrl__DOT__dut__DOT__i_user_spi_ctrl__DOT__dc_q;
        CData/*0:0*/ tb_user_domain_hw_ctrl__DOT__dut__DOT__i_user_spi_ctrl__DOT__dc_d;
        CData/*0:0*/ tb_user_domain_hw_ctrl__DOT__dut__DOT__i_user_spi_ctrl__DOT__rvalid_q;
        CData/*0:0*/ tb_user_domain_hw_ctrl__DOT__dut__DOT__i_user_spi_ctrl__DOT__read_req_accepted;
        ...
        CData/*7:0*/ __Vtask_tb_user_domain_hw_ctrl__DOT__send_byte_hw_ctrl__56__byte_val;
    };
    struct {
        CData/*0:0*/ __Vtask_tb_user_domain_hw_ctrl__DOT__wait_spi_engine_idle__67__busy_bit;
        CData/*0:0*/ __Vtask_tb_user_domain_hw_ctrl__DOT__wait_spi_engine_idle__67__done_bit_tb;
        CData/*0:0*/ __Vtask_tb_user_domain_hw_ctrl__DOT__wait_spi_engine_idle__67__read_err;
        ...
        IData/*31:0*/ tb_user_domain_hw_ctrl__DOT__prng_val1;
        ...
        IData/*31:0*/ tb_user_domain_hw_ctrl__DOT__dut__DOT__i_user_spi_ctrl__DOT__reg_rdata;
        IData/*31:0*/ tb_user_domain_hw_ctrl__DOT__dut__DOT__i_user_spi_ctrl__DOT__i_xorshift__DOT__state_q;
        ...
        IData/*31:0*/ __Vtask_tb_user_domain_hw_ctrl__DOT__send_byte_hw_ctrl__56__cs_pin_idx;
        IData/*31:0*/ __Vtask_tb_user_domain_hw_ctrl__DOT__send_byte_hw_ctrl__56__is_data;
        IData/*31:0*/ __Vtask_tb_user_domain_hw_ctrl__DOT__wait_spi_engine_idle__67__status_val;
        IData/*31:0*/ __Vtask_tb_user_domain_hw_ctrl__DOT__wait_spi_engine_idle__67__timeout_count;
        ...
        VlWide<5>/*155:0*/ tb_user_domain_hw_ctrl__DOT__dut__DOT__all_user_sbr_obi_rsp;
        QData/*38:0*/ tb_user_domain_hw_ctrl__DOT__dut__DOT__user_error_obi_rsp;
        QData/*38:0*/ tb_user_domain_hw_ctrl__DOT__dut__DOT__user_spi_obi_rsp;
        ...
        VlWide<10>/*295:0*/ tb_user_domain_hw_ctrl__DOT__dut__DOT____Vcellout__i_obi_demux__mgr_ports_req_o;
