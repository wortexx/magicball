    ...
    , TOP__soc_ctrl_reg_pkg{this, Verilated::catName(namep, "soc_ctrl_reg_pkg")}
{
    ...
    __Vscope_tb_user_domain_hw_ctrl__dut__i_user_font_rom.configure(this, name(), "tb_user_domain_hw_ctrl.dut.i_user_font_rom", "i_user_font_rom", -9, VerilatedScope::SCOPE_OTHER);
