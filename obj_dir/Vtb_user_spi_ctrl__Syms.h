...
#ifndef VERILATED_VTB_USER_SPI_CTRL__SYMS_H_
#define VERILATED_VTB_USER_SPI_CTRL__SYMS_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES)Vtb_user_spi_ctrl__Syms final : public VerilatedSyms {
  public:
    // INTERNAL STATE
    Vtb_user_spi_ctrl* const __Vm_modelp;
    ...
    Vtb_user_spi_ctrl___024root    TOP;
    Vtb_user_spi_ctrl_soc_ctrl_reg_pkg TOP__soc_ctrl_reg_pkg;
