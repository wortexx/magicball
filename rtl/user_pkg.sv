...
package user_pkg;
  ...
  localparam bit [31:0] UserSpiAddrOffset = UserDomainBaseAddr + 0 * UserPeriphRange; // Example: 32'h2000_0000
  ...
  localparam croc_pkg::addr_map_rule_t [NumDemuxSbrRules-1:0] user_addr_map = {
    ...
    '{ addr_base: UserSpiAddrOffset,
       addr_mask: ~(UserPeriphRange - 1), // Mask for 4KB range: 32'hFFFF_F000
       index:     UserSpi
     }
