...
#endif
            VL_FATAL_MT("tb_obi_spi_direct.sv", 8, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtb_obi_spi_direct___024root___stl_sequent__TOP__0(Vtb_obi_spi_direct___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.tb_obi_spi_direct__DOT__dut__DOT__cs_o = 1U;
    ...
    if ((2U & (IData)(vlSelfRef.tb_obi_spi_direct__DOT__dut__DOT__state_q))) {
        vlSelfRef.tb_obi_spi_direct__DOT__dut__DOT__cs_o 
        ...
        vlSelfRef.tb_obi_spi_direct__DOT__dut__DOT__cs_o = 0U;
        vlSelfRef.tb_obi_spi_direct__DOT__dut__DOT__spi_clk_cnt_d = 0U;
                                                ...
                                                | ((IData)(vlSelfRef.tb_obi_spi_direct__DOT__we) 
                                                   & ((0U 
                                                      ...
                                                      & ((4U 
                                                         ...
                                                         | (0U 
                                                            == vlSelfRef.tb_obi_spi_direct__DOT__addr))))));
    vlSelfRef.tb_obi_spi_direct__DOT__dut__DOT__status_read_req 
        = ((~ (IData)(vlSelfRef.tb_obi_spi_direct__DOT__we)) 
...
VL_ATTR_COLD void Vtb_obi_spi_direct___024root___ctor_var_reset(Vtb_obi_spi_direct___024root* vlSelf) {
    ...
    vlSelf->tb_obi_spi_direct__DOT__dut__DOT__cs_o = VL_RAND_RESET_I(1);
    ...
    vlSelf->tb_obi_spi_direct__DOT__dut__DOT__spi_clk_cnt_q = VL_RAND_RESET_I(3);
    ...
    vlSelf->tb_obi_spi_direct__DOT__dut__DOT__spi_clk_cnt_d = VL_RAND_RESET_I(3);
    vlSelf->tb_obi_spi_direct__DOT__dut__DOT__status_read_req = VL_RAND_RESET_I(1);
    vlSelf->tb_obi_spi_direct__DOT__dut__DOT__unnamedblk1__DOT__next_bit_idx_calc = VL_RAND_RESET_I(4);
